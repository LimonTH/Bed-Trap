...
import static me.bedtrap.addon.util.advanced.BedUtils.getTargetSphere;
import static me.bedtrap.addon.util.basic.BlockInfo.isBlastResist;
...
public class HoleFill extends Module {
    ...
    private boolean validHole(BlockPos pos) {
        ...
        if (mc.player.getPos().distanceTo(new Box(pos.getX(), pos.getY(), pos.getZ(), pos.getX() + 1, pos.getY() + 1, pos.getZ() + 1).getCenter()) < selfIgnore.get())
            return false;
