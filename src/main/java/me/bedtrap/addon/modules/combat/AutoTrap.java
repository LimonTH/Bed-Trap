...
import static me.bedtrap.addon.util.advanced.PacketUtils.packetPlace;
import static me.bedtrap.addon.util.basic.BlockInfo.getSphere;
import static me.bedtrap.addon.util.basic.BlockInfo.isCombatBlock;
...
public class AutoTrap extends Module {
    ...
    public AutoTrap() {
        super(BedTrap.Combat, "auto-trap+", "Places obsidian above target head.");
    }
    ...
    private void add(BlockPos blockPos) {
        if (!placePositions.contains(blockPos) && mc.world.getBlockState(blockPos).isReplaceable() && mc.world.canPlace(Blocks.OBSIDIAN.getDefaultState(), blockPos, ShapeContext.absent()))
