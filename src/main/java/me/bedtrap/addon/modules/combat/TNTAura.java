...
import static me.bedtrap.addon.util.basic.EntityInfo.isSurrounded;
...
public class TNTAura extends Module {
    ...
    public TNTAura() {
        super(BedTrap.Combat, "TNT-Aura", "Placing & igniting TNT above target.");
    }
    ...
    private void onTick(TickEvent.Pre event) {
        ...
        if (ticks >= delay.get() && !obsidianPos.isEmpty()) {
