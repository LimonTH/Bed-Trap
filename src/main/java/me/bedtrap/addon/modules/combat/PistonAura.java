...
import static me.bedtrap.addon.util.advanced.Interaction.doSwing;
import static me.bedtrap.addon.util.advanced.Interaction.hasEntity;
...
public class PistonAura extends Module {
    ...
    public void onTick(TickEvent.Post event) {
        ...
        if (pauseOnEat.get() && mc.player.isUsingItem() && (mc.player.getMainHandStack().getComponents().get(DataComponentTypes.FOOD) != null || mc.player.getOffHandStack().get(DataComponentTypes.FOOD) != null))
            return;
