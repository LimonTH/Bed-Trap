...
public class PistonPush extends Module {
    ...
    public PistonPush() {
        super(BedTrap.Combat, "piston-push", "Automatically pushes targets out of their surround.");
    }
    ...
    public void onTick(TickEvent.Post event) {
        ...
        switch (stage) {
            case Preparing -> {
                ...
                if (antiSelf.get() && hasEntity(new Box(targetPos), entity -> entity == mc.player))
                    stage = Stage.Toggle;
