...
import me.bedtrap.addon.modules.misc.OffHand;
...
import static me.bedtrap.addon.util.basic.BlockInfo.isReplaceable;
...
public class Burrow extends Module {
    ...
    public Burrow() {
        super(BedTrap.Combat, "Burrow+", "Clips you into a block.");
    }
    ...
    public void onActivate() {
        ...
        if (Modules.get().get(OffHand.class).isActive() && Modules.get().get(OffHand.class).anvilOnBurrow.get())
            slot = 45;
