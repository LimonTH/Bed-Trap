...
import me.bedtrap.addon.modules.combat.AutoCrystal;
import me.bedtrap.addon.modules.combat.Burrow;
...
public class OffHand extends Module {
    ...
    public OffHand() {
        super(BedTrap.Misc, "off-hand+", "Automatically puts items in your offhand.");
    }
    ...
    private net.minecraft.item.Item getItemTarget() {
        ...
        if (egapOnSword.get() && mc.player.getMainHandStack().getItem() instanceof SwordItem)
            return getItem(ItemList.EGap);
