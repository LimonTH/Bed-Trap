...
import static me.bedtrap.addon.util.basic.EntityInfo.notNull;
import static me.bedtrap.addon.util.basic.Vec3dInfo.getEyeVec;
...
public class CityUtils {
    public static BlockPos getBreakPos(PlayerEntity target) {
        ...
        BlockPos prevBP = blockArray.getFirst();
    ...
    public static BlockPos getCrystalPos(BlockPos breakPos, boolean support) {
        ...
        return blockPos.isEmpty() ? null : blockPos.getFirst().down();
    }
