...
public class BlockInfo {
    ...
    public static BlockState getState(BlockPos block) {
        return mc.world.getBlockState(block);
    }

    public static VoxelShape getShape(BlockPos block) {
        return getState(block).getOutlineShape(mc.world, block);
    }
    ...
    public static boolean isSolid(BlockPos block) {
        return mc.world.getBlockState(block).isSolidBlock(mc.world, block);
    }
    ...
    public static boolean isLiquid(BlockPos block) {
        return mc.world.getBlockState(block).getBlock() == Blocks.WATER || mc.world.getBlockState(block).getBlock() == Blocks.LAVA;
    }
    ...
    public static boolean isBreakable(BlockPos block) {
    ...
    public static boolean notNull(BlockPos block) {
        return block != null;
    }
    ...
    public static int X(BlockPos block) {
        return block.getX();
    }

    public static int Y(BlockPos block) {
        return block.getY();
    }

    public static int Z(BlockPos block) {
        return block.getZ();
    }
