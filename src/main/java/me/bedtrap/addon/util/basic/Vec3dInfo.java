...
public class Vec3dInfo {
    ...
    public static boolean isWithinRange(Vec3d vec3d, double range) {
        return mc.player.getBlockPos().isWithinDistance(vec3d, range);
    }
    ...
    public static double X(Vec3d vec3d) {
        return vec3d.getX();
    }

    public static double Y(Vec3d vec3d) {
        return vec3d.getY();
    }

    public static double Z(Vec3d vec3d) {
        return vec3d.getZ();
    }
    ...
    public static Vec3d closestVec3d(BlockPos blockpos) {
        return BlockInfo.closestVec3d(blockpos);
    }
}
